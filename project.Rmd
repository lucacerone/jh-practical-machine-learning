...
In this project we use data collected  try to predict whether an exercise has been performed correctly or not using accelerometers' data measured using wearable 
devices. A group of participants has been asked to perform different exercises in
